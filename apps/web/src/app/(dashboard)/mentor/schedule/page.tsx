...
export default function MentorSchedulePage() {
  ...
  useEffect(() => {
    scheduleApiClient
      .get<{ success: boolean; data: Schedule[] }>('/api/schedules/my/mentor')
  ...
  return (
    <ProtectedRoute allowedRoles={[Role.MENTOR]}>
      <div className="max-w-3xl mx-auto pb-12">
        ...
        <p className="text-[#6B7280] mb-8">Your weekly teaching timetable</p>
                          ...
                          >
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-[#9CA3AF]">· Period {s.period}</span>
                                <span
                                  className={`text-xs px-2 py-0.5 rounded-full border ${SHIFT_COLORS[s.shift] ?? ''}`}
                                >
                                  {s.shift}
                                </span>
                              </div>
